...
import { Heart, Trash2, Calendar, Star, Leaf } from 'lucide-react';
  ...
  if (favoritePlants.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
        ...
        <p className="mt-2 text-base text-muted-foreground">Favorite a plant from your history to see it here.</p>
